            ...
            <Modal visible={selectedItem !== null} animationType="slide">
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        <Text style={styles.modalText}>Nombre Empresa: {selectedItem?.nombre}</Text>
                        ...
                        <Text style={styles.modalText}>Municipio: {selectedItem?.Municipio}</Text>
                        <Text style={styles.modalText}>Estado: {selectedItem?.estado}</Text>
                        <Text style={styles.modalText}>CP: {selectedItem?.CP}</Text>
